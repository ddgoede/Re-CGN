...
mkdir -p $REPO_PATH/cgn_framework/imagenet/data/sketch/val/
mv $REPO_PATH/cgn_framework/imagenet/data/sketch/* $REPO_PATH/cgn_framework/imagenet/data/sketch/val/