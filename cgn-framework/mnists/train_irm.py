"""Trainer script for IRM.

Code: https://github.com/facebookresearch/InvariantRiskMinimization/
Paper: https://arxiv.org/pdf/1907.02893v1.pdf
...
for restart in range(flags.n_restarts):
    ...
    print("Building {} environments ...".format(flags.n_envs))
    if flags.n_envs == 2:
        envs = [
        ...
        envs = [
            make_environment(mnist_train[0][::2], mnist_train[1][::2], 0.0),
            make_environment(mnist_train[0][1::2], mnist_train[1][1::2], 0.1),
            make_environment(mnist_val[0], mnist_val[1], 1.0)
        ]
    else:
        raise ValueError("Invalid number of environments: {}. Use value in {2, 5}".format(flags.n_envs))
